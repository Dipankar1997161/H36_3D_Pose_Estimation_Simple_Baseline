...
class LinearModel(object):
  ...
  def two_linear( self, xin, linear_size, residual, dropout_keep_prob, max_norm, batch_norm, dtype, idx ):
    ...
    with vs.variable_scope( "two_linear_"+str(idx) ):
      ...
      if  batch_norm:
        y = tf.compat.v1.layers.batch_normalization(y,training=self.isTraining,name="batch_normalization1"+str(idx))
      ...
      if  batch_norm:
        y = tf.compat.v1.layers.batch_normalization(y,training=self.isTraining,name="batch_normalization2"+str(idx))
